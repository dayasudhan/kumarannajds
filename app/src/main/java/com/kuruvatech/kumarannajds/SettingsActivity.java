...
/**
 * Created by dayas on 03-12-2017.
 */
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            Preference myPref2 = findPreference(getString(R.string.key_upload_quality));
            myPref2.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {

                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if (preference.getSummary().toString().equals("Kannada")) {
    ...
    public static void sendFeedback(Context context) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"kuruvatechnologies@gmail.com"});
